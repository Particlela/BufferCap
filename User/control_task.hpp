...
public:
    ...
    static constexpr float k_vcap_high = 28.0f;
    static constexpr float k_vcap_low  = 11.0f; 
    static constexpr float k_vcap_max  = 29.0f;
    ...
    static constexpr float k_vin_discharge_threshold = 22.4f;
    static constexpr float k_vin_reg_target          = 22.5f;
